...
Breadcrumbs::for('posts', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.posts.title'), route('admin.posts.index'));
});

// Dashboard > posts > Create Product
Breadcrumbs::for('posts.create', function (BreadcrumbTrail $trail) {
    $trail->parent('posts');
    $trail->push(trans('admin::app.posts.create-title'), route('admin.posts.create'));
});

// Dashboard > posts > Edit Product
Breadcrumbs::for('posts.edit', function (BreadcrumbTrail $trail, $posts) {
    $trail->parent('posts');
    $trail->push(trans('admin::app.posts.edit-title'), route('admin.posts.edit', $posts->id));
});
...
Breadcrumbs::for('category', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.category.title'), route('admin.category.index'));
});

// Dashboard > category > Create Product
Breadcrumbs::for('category.create', function (BreadcrumbTrail $trail) {
    $trail->parent('category');
    $trail->push(trans('admin::app.category.create-title'), route('admin.category.create'));
});

// Dashboard > category > Edit Product
Breadcrumbs::for('category.edit', function (BreadcrumbTrail $trail, $category) {
    $trail->parent('category');
    $trail->push(trans('admin::app.category.edit-title'), route('admin.category.edit', $category->id));
});

// tags
Breadcrumbs::for('tags', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.tags.title'), route('admin.tags.index'));
});

// Dashboard > tags > Create Product
Breadcrumbs::for('tags.create', function (BreadcrumbTrail $trail) {
    $trail->parent('tags');
    $trail->push(trans('admin::app.tags.create-title'), route('admin.tags.create'));
});

// Dashboard > tags > Edit Product
Breadcrumbs::for('tags.edit', function (BreadcrumbTrail $trail, $product) {
    $trail->parent('tags');
    $trail->push(trans('admin::app.tags.edit-title'), route('admin.tags.edit', $product->id));
});
