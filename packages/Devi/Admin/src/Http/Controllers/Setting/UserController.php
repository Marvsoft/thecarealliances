...
use Devi\User\Repositories\GroupRepository;
use Devi\User\Repositories\UserRepository;
use Devi\Admin\Notifications\User\Create;
...
class UserController extends Controller
{
     ...
     *
     * @var \Devi\User\Repositories\UserRepository
     */
     ...
     *
     * @var \Devi\User\Repositories\RoleRepository
     */
     ...
     *
     * @param  \Devi\User\Repositories\UserRepository  $userRepository
     * @param  \Devi\User\Repositories\GroupRepository  $groupRepository
     * @param  \Devi\User\Repositories\RoleRepository  $roleRepository
     * @return void
     */
    ...
    {
        if (request()->ajax()) {
            return app(\Devi\Admin\DataGrids\Setting\UserDataGrid::class)->toJson();
        }
