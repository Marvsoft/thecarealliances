...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Edsathi'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Designed by Suraj Kashyap with ❤️')}} <a href="{{__('https://facebook.com/haddhaisuraj')}}" target="_blank">{{__('Suraj Kashyap')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://facebook.com/haddhaisuraj')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://m.me/edsathi')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
