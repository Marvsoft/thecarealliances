...
@push('scripts')
    ...
    <script>
        Vue.component('workflow-component', {
            ...
            data: function() {
                return {
                    events: @json(app('\Devi\Workflow\Helpers\Entity')->getEvents()),
        ...
        Vue.component('workflow-condition-item', {
            ...
            data: function() {
                return {
                    conditions: @json(app('\Devi\Workflow\Helpers\Entity')->getConditions()),
        ...
        Vue.component('workflow-action-item', {
            ...
            data: function() {
                return {
                    actions: @json(app('\Devi\Workflow\Helpers\Entity')->getActions()),
                }
            },
